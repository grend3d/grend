...
BASEFLAGS += $(CONF_C_FLAGS) $(CONF_GL_FLAGS) $(CONF_EM_FLAGS)
BASEFLAGS += $(CONF_PHYSICS_FLAGS) $(DEFINES)
BASEFLAGS += $(INCLUDES) -MD -Wall -MD -O2 -fPIC -pthread
BASEFLAGS += -D GR_PREFIX='"$(PREFIX)/share/grend/"'
BASEFLAGS += -D GREND_ERROR_CHECK=$(CONF_DEBUG)
