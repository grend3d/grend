...
void StyleColorsGrendDark(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_TitleBg]                = ImVec4(0.25f, 0.25f, 0.25f, 0.83f);
    colors[ImGuiCol_TitleBgActive]          = ImVec4(0.90f, 0.44f, 0.18f, 0.87f);
    colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.80f, 0.40f, 0.20f, 0.20f);

    colors[ImGuiCol_MenuBarBg]              = ImVec4(0.40f, 0.40f, 0.40, 0.80f);
    ...
    colors[ImGuiCol_Button]                 = ImVec4(0.61f, 0.45f, 0.35f, 0.62f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.71f, 0.52f, 0.40f, 0.79f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.80f, 0.60f, 0.42f, 1.00f);

    colors[ImGuiCol_Header]                 = ImVec4(0.90f, 0.50f, 0.35f, 0.45f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.90f, 0.50f, 0.40f, 0.80f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.87f, 0.60f, 0.40f, 0.80f);
